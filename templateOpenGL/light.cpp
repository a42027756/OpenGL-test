...
//    Shader lightCubeShader("Shaders/shaderLight.vs", "Shaders/lamp.fs");
//
...
//        lightingShader.setFloat("light.outerCutoff", cos(glm::radians(17.5f)));
//        lightingShader.setBool("isFlashLight", false);
//
//        // material properties
